...
message("root: ${INSTALL_PATH}")
  
find_path(JSONBOX_INCLUDE_DIRS "JsonBox.h" HINTS 
   "${JSONBOX_ROOT}/include"
...
find_library(JSONBOX_LIBRARY_RELEASE NAMES JsonBox HINTS "${INSTALL_PATH}/lib")
...
messagE("JSONBOX LIBS: ${JSONBOX_LIBRARIES}")
